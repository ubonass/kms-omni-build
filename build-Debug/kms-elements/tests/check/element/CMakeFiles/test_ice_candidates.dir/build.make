...
kms-elements/tests/check/element/CMakeFiles/test_ice_candidates.dir/ice_candidates.c.o: ../kms-elements/tests/check/element/ice_candidates.c
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/root/workSpace/kms-omni-build/build-Debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building C object kms-elements/tests/check/element/CMakeFiles/test_ice_candidates.dir/ice_candidates.c.o"
	cd /root/workSpace/kms-omni-build/build-Debug/kms-elements/tests/check/element && /usr/bin/cc  $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -o CMakeFiles/test_ice_candidates.dir/ice_candidates.c.o   -c /root/workSpace/kms-omni-build/kms-elements/tests/check/element/ice_candidates.c
...
kms-elements/tests/check/element/CMakeFiles/test_ice_candidates.dir/ice_candidates.c.i: cmake_force
	...
	cd /root/workSpace/kms-omni-build/build-Debug/kms-elements/tests/check/element && /usr/bin/cc  $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -E /root/workSpace/kms-omni-build/kms-elements/tests/check/element/ice_candidates.c > CMakeFiles/test_ice_candidates.dir/ice_candidates.c.i
...
kms-elements/tests/check/element/CMakeFiles/test_ice_candidates.dir/ice_candidates.c.s: cmake_force
	...
	cd /root/workSpace/kms-omni-build/build-Debug/kms-elements/tests/check/element && /usr/bin/cc  $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -S /root/workSpace/kms-omni-build/kms-elements/tests/check/element/ice_candidates.c -o CMakeFiles/test_ice_candidates.dir/ice_candidates.c.s
...
kms-elements/tests/check/element/test_ice_candidates: kms-elements/src/gst-plugins/webrtcendpoint/libkmswebrtcendpointlib.so.6.10.0
kms-elements/tests/check/element/test_ice_candidates: kms-elements/src/gst-plugins/webrtcendpoint/libwebrtcdataproto.so.6.10.0
kms-elements/tests/check/element/test_ice_candidates: kms-core/src/gst-plugins/commons/libkmsgstcommons.so.6.10.0
kms-elements/tests/check/element/test_ice_candidates: kms-core/src/gst-plugins/commons/sdpagent/libkmssdpagent.so.6.10.0
...
kms-elements/tests/check/element/test_ice_candidates: kms-elements/tests/check/element/CMakeFiles/test_ice_candidates.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/root/workSpace/kms-omni-build/build-Debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking C executable test_ice_candidates"
	cd /root/workSpace/kms-omni-build/build-Debug/kms-elements/tests/check/element && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/test_ice_candidates.dir/link.txt --verbose=$(VERBOSE)
...
kms-elements/tests/check/element/CMakeFiles/test_ice_candidates.dir/clean:
	cd /root/workSpace/kms-omni-build/build-Debug/kms-elements/tests/check/element && $(CMAKE_COMMAND) -P CMakeFiles/test_ice_candidates.dir/cmake_clean.cmake
...
kms-elements/tests/check/element/CMakeFiles/test_ice_candidates.dir/depend:
	cd /root/workSpace/kms-omni-build/build-Debug && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/workSpace/kms-omni-build /root/workSpace/kms-omni-build/kms-elements/tests/check/element /root/workSpace/kms-omni-build/build-Debug /root/workSpace/kms-omni-build/build-Debug/kms-elements/tests/check/element /root/workSpace/kms-omni-build/build-Debug/kms-elements/tests/check/element/CMakeFiles/test_ice_candidates.dir/DependInfo.cmake --color=$(COLOR)
