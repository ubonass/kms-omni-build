...
kurento-media-server/test/CMakeFiles/test_server_json.check: kurento-media-server/test/test_server_json
	cd /root/workSpace/kms-omni-build/build-Debug/kurento-media-server/test && MEDIA_SERVER_CONF_FILE=/root/workSpace/kms-omni-build/kurento-media-server/test/../kurento.conf.json SERVER_DIR=/root/workSpace/kms-omni-build/build-Debug/kurento-media-server/test/../server/kurento-media-server GST_PLUGIN_PATH=:/root/workSpace/kms-omni-build/build-Debug KURENTO_MODULES_PATH=:/root/workSpace/kms-omni-build/build-Debug BOOST_TEST_CATCH_SYSTEM_ERRORS=no /root/workSpace/kms-omni-build/build-Debug/kurento-media-server/test/test_server_json ${ARGS}
...
kurento-media-server/test/CMakeFiles/test_server_json.check.dir/clean:
	cd /root/workSpace/kms-omni-build/build-Debug/kurento-media-server/test && $(CMAKE_COMMAND) -P CMakeFiles/test_server_json.check.dir/cmake_clean.cmake
...
kurento-media-server/test/CMakeFiles/test_server_json.check.dir/depend:
	cd /root/workSpace/kms-omni-build/build-Debug && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/workSpace/kms-omni-build /root/workSpace/kms-omni-build/kurento-media-server/test /root/workSpace/kms-omni-build/build-Debug /root/workSpace/kms-omni-build/build-Debug/kurento-media-server/test /root/workSpace/kms-omni-build/build-Debug/kurento-media-server/test/CMakeFiles/test_server_json.check.dir/DependInfo.cmake --color=$(COLOR)
